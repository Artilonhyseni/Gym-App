...
export default function Generator(props) {
  ...
  function updateMuscles(muscleGroup) {
    ...
    if (poison !== 'individual') setMuscles([muscleGroup]);
    return;
  }
            ...
            {(poison === 'individual'
              ...
              return (
                <button
                  ...
                  className={`hover:text-blue-400 duration-200 px-4 ${
        ...
        {Object.keys(SCHEMES).map((scheme, schemeIndex) => {
          return (
            <button
              ...
              className={
                'bg-slate-950 border py-3 duration-200 px-4 hover:border-blue-600 rounded-lg ' +
